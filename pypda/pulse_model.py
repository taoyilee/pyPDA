...
class PulseModelRaw(Waveform):
    def __init__(self, pulse_amplitudes: Tuple[float] = (8, 3, 4, 2, 1),
                 ...
                 triangle_m: Tuple[int] = (20, 20, 20, 20, 20),
                 gaussian_m: Tuple[int] = (16, 16, 16, 16, 16),
                 gaussian_std: Tuple[int] = (2, 2, 2, 2, 2)):
        ...
        self.wavelets = [TriangGaussian(amplitude=am, triang_m=tm, gaussian_m=gm, gaussian_std=gs) for
                         am, tm, gm, gs in zip(pulse_amplitudes, triangle_m, gaussian_m, gaussian_std)]
